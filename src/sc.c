...
void sc_reduce(unsigned char *s) {
    ...
    int64_t s8_ = 2097151 & load_3(s + 21);
    ...
    int64_t s16_ = 2097151 & load_3(s + 42);
    ...
    s[21] = (unsigned char) (s8_ >> 0);
    s[22] = (unsigned char) (s8_ >> 8);
    s[23] = (unsigned char) ((s8_ >> 16) | (s9 << 5));
...
void sc_muladd(unsigned char *s, const unsigned char *a, const unsigned char *b, const unsigned char *c) {
    ...
    s8_ = c8 + a0 * b8 + a1 * b7 + a2 * b6 + a3 * b5 + a4 * b4 + a5 * b3 + a6 * b2 + a7 * b1 + a8 * b0;
    ...
    s16_ = a5 * b11 + a6 * b10 + a7 * b9 + a8 * b8 + a9 * b7 + a10 * b6 + a11 * b5;
